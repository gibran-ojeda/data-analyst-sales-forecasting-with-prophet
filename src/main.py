...
DIRECTORY = "./data/sales" # Directory where the excel files are located
KEYWORDS = "Ventas por Tickets" # Keyword to search for in the file names
SALES_COLUMNS =  [
    WAREHOUSE,
    DATE,
    SALE_PRICE
]
OUTPUT_PATH = "./output/prophet" # Path to save the output file
